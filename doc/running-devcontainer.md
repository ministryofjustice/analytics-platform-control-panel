...
If you have an existing local `.env` file, there are slight differences. Notably `AWS_CONFIG_FILE` needs to be added and `AWS_PROFILE` needs changing to reference dev-container directories.
