...
urlpatterns = [
    ...
    path("policies/", views.IAMManagedPolicyList.as_view(), name="list-policies"),
    path("policies/all/", views.AdminIAMManagedPolicyList.as_view(), name="list-all-policies"),
    path("policies/new/", views.IAMManagedPolicyCreate.as_view(), name="create-policy"),
    path("policies/<int:pk>/delete/", views.IAMManagedPolicyDelete.as_view(), name="delete-policy"),
    path("policies/<int:pk>/", views.IAMManagedPolicyDetail.as_view(), name="manage-policy"),
    path("policies/<int:pk>/user/<str:user_id>/delete/", views.IAMManagedPolicyRemoveUser.as_view(), name="policy-remove-user"),
    path("datasources/<int:pk>/update-policy-access/", views.UpdateIAMManagedPolicyAccessLevel.as_view(), name="update-policy-access-level"),
    path("datasources/<int:pk>/delete-policy-access/", views.RevokeIAMManagedPolicyAccess.as_view(), name="revoke-datasource-policy-access"),
    path("datasources/<int:pk>/policy-access/", views.GrantPolicyAccess.as_view(), name="grant-datasource-policy-access"),
