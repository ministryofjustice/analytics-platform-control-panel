...
DASHBOARD_AUTH0_ROLE_ID = os.environ.get("DASHBOARD_AUTH0_ROLE_ID")

NOTIFY_API_KEY = os.environ.get("NOTIFY_API_KEY")
NOTIFY_DASHBOARD_ACCESS_TEMPLATE_ID = os.environ.get("NOTIFY_DASHBOARD_ACCESS_TEMPLATE_ID")
NOTIFY_DASHBOARD_REVOKED_TEMPLATE_ID = os.environ.get("NOTIFY_DASHBOARD_REVOKED_TEMPLATE_ID")
NOTIFY_DASHBOARD_ADMIN_ADDED_TEMPLATE_ID = os.environ.get(
    "NOTIFY_DASHBOARD_ADMIN_ADDED_TEMPLATE_ID"
)
NOTIFY_DASHBOARD_ADMIN_REMOVED_TEMPLATE_ID = os.environ.get(
    "NOTIFY_DASHBOARD_ADMIN_REMOVED_TEMPLATE_ID"
)
