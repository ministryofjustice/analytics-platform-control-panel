...
add_perm('api.list_release', is_authenticated & is_superuser)
add_perm('api.create_release', is_authenticated & is_superuser)
add_perm('api.destroy_release', is_authenticated & is_superuser)
add_perm('api.update_release', is_authenticated & is_superuser)
