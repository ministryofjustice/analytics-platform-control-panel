...
# Third-party
from rules import add_perm, is_authenticated, is_superuser, predicate
...
add_perm("api.list_apps3bucket", is_authenticated & is_iam_user)
...
add_perm("api.list_users3bucket", is_authenticated & is_iam_user)
...
add_perm("api.add_dashboard_viewer", is_authenticated & is_dashboard_admin)
...
add_perm("api.revoke_dashboard_viewer", is_authenticated & is_dashboard_admin)
