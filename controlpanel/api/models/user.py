...
class User(AbstractUser):
    ...
    def is_quicksight_author(self):
        return self.has_perm("api.quicksight_embed_author_access")

    def is_quicksight_user(self):
        return self.is_quicksight_author() or self.has_perm("api.quicksight_embed_reader_access")
