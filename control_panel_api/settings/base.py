...
AIRFLOW_AUTH_CLIENT_DOMAIN = os.environ.get('AIRFLOW_AUTH_CLIENT_DOMAIN', OIDC_DOMAIN)
AIRFLOW_AUTH_CLIENT_ID = os.environ.get('AIRFLOW_AUTH_CLIENT_ID')
AIRFLOW_AUTH_CLIENT_SECRET = os.environ.get('AIRFLOW_AUTH_CLIENT_SECRET')
